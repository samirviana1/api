...
app.post("/login", middlewares_1.buscarUser, services_1.user.logUser);
app.post("/users", middlewares_1.userExiste, middlewares_1.validaUser, services_1.user.createUser);
...
app.get("/notes/:uid", services_1.stickynotes.searchStickynotesForId);
...
app.listen(port, () => console.log("server estatus: positivo e operante na porta:", `${port}`));
